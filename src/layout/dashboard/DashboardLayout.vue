  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/dataprocessor" :name="$t('sidebar.dataProcessor')" icon="tim-icons icon-components"/>
         <sidebar-link to="/model-training" :name="$t('sidebar.modelTraining')" icon="tim-icons icon-vector"/>
